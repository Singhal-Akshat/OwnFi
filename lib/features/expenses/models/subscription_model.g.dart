...
void _subscriptionSerialize(
  ...
  writer.writeDateTime(offsets[5], object.nextRenewalDate);
...
Subscription _subscriptionDeserialize(
  ...
  object.billingCycle = reader.readString(offsets[1]);
  object.category = reader.readString(offsets[2]);
  object.id = id;
  object.isActive = reader.readBool(offsets[3]);
  object.name = reader.readString(offsets[4]);
  object.nextRenewalDate = reader.readDateTimeOrNull(offsets[5]);
...
extension SubscriptionQueryProperty
  ...
  QueryBuilder<Subscription, String, QQueryOperations> billingCycleProperty() {
    return QueryBuilder.apply(this, (query) {
